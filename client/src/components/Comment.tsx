...
export default function Comment({ fullname, username, comment_text }: Props) {
    return (
        <div className="grid grid-cols-[40px_1fr] gap-x-4 border-b-[1px] border-zinc-300 pb-4 last:border-none">
            <img
                src={profileImg1}
                width="40"
